...
const PresentacionTableNewContent = () => {
  ...
  return (
    <StandardDataTable
      ...
      endpoint="http://localhost:8000/api/presentacions"
      columns={columns}
      
      // Configuración de UI
      title="Presentacions"
      subtitle="Gestión de presentacions del sistema"
      ...
      FormComponent={PresentacionForm}
...
const PresentacionTableNew = () => {
  return (
    <TableThemeProvider>
      <PresentacionTableNewContent />
    </TableThemeProvider>
  );
};

export default PresentacionTableNew;
