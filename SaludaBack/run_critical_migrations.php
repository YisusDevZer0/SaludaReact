...
echo "=== EJECUTANDO MIGRACIONES CRÍTICAS ===\n\n";

// Migraciones en orden de dependencias (primero las tablas base, luego las que dependen de ellas)
$criticalMigrations = [
    ...
    // 9. Tablas de transferencias (requieren corrección de claves foráneas)
...
echo "=== MIGRACIONES CRÍTICAS FINALIZADAS ===\n"; 