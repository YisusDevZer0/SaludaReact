    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST', 'srv1545.hstgr.io'),
            'port' => env('DB_PORT', '3306'),
            'database' => env('DB_DATABASE', 'u155356178_SaludaCore'),
            'username' => env('DB_USERNAME', 'u155356178_SaludaCoreDevs'),
            'password' => env('DB_PASSWORD', 'Saluda2025$&/&'),
        ...
        'mysql_second' => [
            ...
            'host' => env('DB_SECOND_HOST', 'srv1545.hstgr.io'),
        ...
        'mysql_core' => [
            ...
            'host' => env('DB_CORE_HOST', 'srv1545.hstgr.io'),
            'port' => env('DB_CORE_PORT', '3306'),
            'database' => env('DB_CORE_DATABASE', 'u155356178_SaludaCore'),
            'username' => env('DB_CORE_USERNAME', 'u155356178_SaludaCoreDevs'),
