...
return new class extends Migration
{
    ...
    {
        Schema::create('creditos_dentales', function (Blueprint $table) {
            $table->id();
            $table->string('numero_credito_dental', 50)->unique();
            ...
            // Información del tratamiento dental
            $table->enum('tipo_tratamiento', [
                ...
                'estetica_dental', 'reparacion', 'mixto'
            ])->default('mixto');
            ...
            $table->decimal('interes_mensual', 5, 2)->default(0.00);
            $table->decimal('mora_diaria', 5, 2)->default(0.00);
            ...
            $table->text('diagnostico_dental')->nullable();
            $table->text('plan_tratamiento')->nullable();
            $table->text('dientes_afectados')->nullable();
            $table->text('procedimientos_realizados')->nullable();
            $table->text('materiales_utilizados')->nullable();
            
            // Fases del tratamiento
            $table->enum('fase_tratamiento', ['evaluacion', 'planificacion', 'ejecucion', 'finalizacion', 'seguimiento'])->default('evaluacion');
            ...
            // Índices
            $table->index(['numero_credito_dental', 'estado']);
    ...
    {
        Schema::dropIfExists('creditos_dentales');
    }
}; 